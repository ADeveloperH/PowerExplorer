...
public class GateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkPackInfo("com.bxvip.app.bx152zy")) {
            openPackage(DocumentsApplication.getInstance(), "com.bxvip.app.bx152zy");
        } else {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    startActivity(new Intent(GateActivity.this, DocumentsActivity.class));
                    finish();
                }
            }
        }).start();
    ...
    private boolean checkPackInfo(String packname) {
        ...
        try {
            packageInfo = DocumentsApplication.getInstance().getPackageManager().getPackageInfo(packname, 0);
